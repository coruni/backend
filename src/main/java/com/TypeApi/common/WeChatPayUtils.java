...
public class WeChatPayUtils {
     ...
     */
    private static CloseableHttpClient initHttpClient(Apiconfig apiconfig){
...
//            //向证书管理器增加商户信息，并开启自动更新
     ...
     * @return
     */
    public static Map<String, String> native_payment_order(String money, String body, String outTradeNo, Apiconfig apiconfig) {
        try {
     ...
     * @return
     */
    public static Map<String, String> native_query_order(String outTradeNo, Apiconfig apiconfig) {
        CloseableHttpResponse response = null;
        String MCH_ID = apiconfig.getWxpayMchId();
        try {
...
//                resultMap.put("transactionId", String.valueOf(data.get("transaction_id")));
     ...
     * @return
     */
    public static Map<String, Object> paramDecodeForAPIV3(Map<String, Object> map, Apiconfig apiconfig){
        String MCH_API_V3_KEY = apiconfig.getMchApiV3Key();
