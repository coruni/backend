    ...
    public String install(@RequestParam(value = "username", required = false) String username,
        ...
        try {
            ...
            String createTableSQL = "CREATE TABLE IF NOT EXISTS`" + users + "` ("
                    ...
                    + "`vip` int(10) NOT NULL DEFAULT '0' COMMENT '会员时间',"
                    + "`assets` int(11) NOT NULL DEFAULT '0' COMMENT '用户积分',"
                    ...
                    + "`bantime` int(10) NOT NULL DEFAULT '0' COMMENT '封禁时间',"
                    + "`logged` int(10) NOT NULL DEFAULT '0' COMMENT '登录时间',"
                    + "`activated` int(10) NOT NULL DEFAULT '0' COMMENT '活动时间',"
